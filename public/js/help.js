  ...
  // ── REPORTS ──────────────────────────────────────────────────────────────────
  {
    ...
    items:[
      ...
      { q:'RX Action Report tab — what it shows',
        a:'The RX Action Report shows a table of all RX records with: RX Number, Patient name, Patient ID, Pharmacy, Service Date, Completed Steps (list of checked-off steps), Next Pending Step (the next step waiting to be done), and Progress (a percentage bar). This is the most useful report for operations — you can instantly see which RX records are stuck and at what step.' },
