...
**Applies to:** RX Tracker 3.3.1, RX Softphone 0.4.2, Windows 10/11 x64, Kasm at `https://portal.rbandrc.com`, and a public Asterisk PBX
...
## 9. Managed workstation behavior in 0.4.2

Version 0.4.2 is managed by RX Tracker by default:
...
Do not deploy below 0.4.2 to managed Call Center workstations: 0.4.1 retains call telemetry but exposes local account controls, and earlier builds also lack the pre-answer cancellation correction.
...
- [ ] Entire 0.4.2 ZIP is extracted to an administrator-controlled permanent folder.
...
- [ ] Administrator can see version 0.4.2, managed status, and synchronized account in **Phone Devices**.
