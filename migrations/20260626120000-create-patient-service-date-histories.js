...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('PatientServiceDateHistories', ['patientId'], {
      name: 'idx_patient_service_date_histories_patient'
    });
    await queryInterface.addIndex('PatientServiceDateHistories', ['patientId', 'createdAt'], {
      name: 'idx_patient_service_date_histories_patient_created'
    });
    await queryInterface.addIndex('PatientServiceDateHistories', ['newServiceDate'], {
