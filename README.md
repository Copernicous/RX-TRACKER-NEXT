...
| RX Softphone | Version 0.5.0 runs as a status-aware Windows tray application, supports optional PBX Authentication ID, and is published as a separate, checksummed workstation ZIP |
