...
| RX Softphone | Version 0.4.4 supports an optional PBX Authentication ID, fixes authenticated outbound call stability, and is published as a separate, checksummed workstation ZIP |
