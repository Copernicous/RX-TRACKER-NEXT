...
async function main() {
    ...
    try {
        ...
        const client = { version: '0.4.4', managedMode: true, allowManualDialing: true };
        ...
        assert.strictEqual(pair.policy.minimumClientVersion, '0.4.4');
        ...
        await device.reload();
        assert.strictEqual(device.snapshot.clientVersion, '0.4.4');
        ...
        assert.strictEqual(adminEntry.device.clientVersion, '0.4.4');
